...
public class CartController {
    ...
    public ModelAndView showCart(@RequestParam(name = "result", required = false) String result) {
        ...
        if (result != null) {
            switch (result) {
                case "updated":
                    modelAndView.addObject("message", "Carrinho atualizado com sucesso");
                    break;

                case "error":
                    modelAndView.addObject("message", "Algo de errado aconteceu!!");
                    break;

                case "added":
                    modelAndView.addObject("message", "Adicionado ao carrinho com sucesso!");
                    break;

                case "deleted":
                    modelAndView.addObject("message", "O seu carrinho foi removido com sucesso");
                    break;
                default:
                    break;
            }
