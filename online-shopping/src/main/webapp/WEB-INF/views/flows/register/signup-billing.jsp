                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h4>Registo - Pessoal</h4>
                        </div>
                        <div class="panel-body">
                            <sf:form method="POST" class="form-horizontal" id="billingForm" modelAttribute="billing">
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="addressLineOne">Primeiro Endereco</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="addressLineTwo">Segundo Endereco</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="postalCode">Codigo
                                        Postal</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="state">Regiao</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="country">Pais
                                    </label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <div class="col-md-offset-4 col-md-8">
                                        ...
                                        <button type="submit" class="btn btn-primary" name="_eventId_confirm">
                                            Proximo<span class="glyphicon glyphicon-chevron-right"></span>
                                        </button>
